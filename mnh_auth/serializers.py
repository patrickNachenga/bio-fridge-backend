...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = [
            'guid','username','email','pf_number','first_name', 'middle_name','last_name','status',
            'dob','sex','is_active','is_staff','photo','signature','phone_number','alternative_contact',
            'created_at','updated_at','created_by','groups', 'user_permissions'
        ]
        read_only_fields = [
            'guid', 'username', 'status', 'updated_at', 'created_at', 'updated_at',
        ]
